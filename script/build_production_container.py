...
parser = argparse.ArgumentParser(description="Build production container images for OurChat.")
parser.add_argument('--extension', type=str, default="latest", help="The extension tag for the images (default: latest).")
parser.add_argument('--skip-base', default=True,action='store_true', help="Skip building the base images.")
parser.add_argument('--push', default=False, action="store_true", help="Push the images to Docker Hub.")
