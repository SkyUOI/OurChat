...
Refer to the subdirectory-specific AGENTS.md files for detailed guidance:

- server/AGENTS.md – Rust toolchain, build commands, architecture, configuration, testing, database operations, deployment
- client/AGENTS.md – Flutter development, build commands, architecture, state management, local database, gRPC integration, internationalization
- service/AGENTS.md – Protobuf/gRPC service definitions and code generation
- server/web-panel/AGENTS.md – Vue 3 web administration panel
