    ...
    <div class="service-status">
      ...
      <el-table :data="services" style="width: 100%">
        ...
        <el-table-column :label="$t('actions')" width="120">
          <template #default="scope">
            <el-button size="small" v-if="scope.row.statusKey === 'running'">{{ $t('restart') }}</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      services: [
        { name: 'Web服务器', statusKey: 'running', uptime: '12天 3小时', cpu: '12%', memory: '256MB' },
        { name: '数据库服务', statusKey: 'running', uptime: '8天 7小时', cpu: '8%', memory: '512MB' },
