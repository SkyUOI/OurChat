...
impl MigratorTrait for Migrator {
    fn migrations() -> Vec<Box<dyn MigrationTrait>> {
        vec![
            ...
            Box::new(m20250607_110239_add_room_key_time_and_leaving_to_process_in_session::Migration),
            Box::new(m20250607_144007_add_public_key_in_user::Migration),
            Box::new(m20250609_074125_change_sender_id_to_be_optional_in_message_records::Migration),
