...
class Ui_Setting(object):
    def setupUi(self, Setting):
        ...
        spacerItem = QtWidgets.QSpacerItem(20, 57, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.ip_label)
        self.ip_editor = QtWidgets.QLineEdit(parent=self.server)
        self.ip_editor.setObjectName("ip_editor")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.ip_editor)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.port_editor)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.LabelRole, self.reconnection_attempt_label)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.ItemRole.FieldRole, self.reconnection_attempt_box)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(20, 70, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.language_label)
        self.language_combobox = QtWidgets.QComboBox(parent=self.general)
        self.language_combobox.setObjectName("language_combobox")
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.language_combobox)
        self.theme_label = QtWidgets.QLabel(parent=self.general)
        self.theme_label.setText("Theme")
        self.theme_label.setObjectName("theme_label")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.theme_label)
        self.theme_combobox = QtWidgets.QComboBox(parent=self.general)
        self.theme_combobox.setObjectName("theme_combobox")
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.ItemRole.FieldRole, self.theme_combobox)
        self.horizontalLayout_3.addLayout(self.formLayout_2)
        spacerItem6 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem6)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        spacerItem7 = QtWidgets.QSpacerItem(20, 70, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(20, 69, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.LabelRole, self.log_level_label)
        self.log_level_combobox = QtWidgets.QComboBox(parent=self.advanced)
        self.log_level_combobox.setObjectName("log_level_combobox")
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.ItemRole.FieldRole, self.log_level_combobox)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.ItemRole.LabelRole, self.log_saving_limit_label)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(20, 69, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
