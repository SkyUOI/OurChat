...
class Ui_Setting(object):
    def setupUi(self, Setting):
        ...
        self.gridLayout.addWidget(self.license_label, 2, 1, 1, 1)
        self.version_label = QtWidgets.QLabel(parent=self.about)
        self.version_label.setText("Version")
        self.version_label.setObjectName("version_label")
        self.gridLayout.addWidget(self.version_label, 0, 1, 1, 1)
        self.github_btn = QtWidgets.QPushButton(parent=self.about)
        self.github_btn.setObjectName("github_btn")
        self.gridLayout.addWidget(self.github_btn, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Setting):
        ...
        self.github_btn.setText(_translate("Setting", "Github"))
