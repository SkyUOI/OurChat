  ...
  Widget build(BuildContext context) {
    ...
    if (!inited) {
      if (enableVersionCheck) {
        needUpdate(Uri.parse(config.updateSource), true, true).then((value) {
          setState(() {
            updateData = value;
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            UpdateWidget(updateData: updateData),
                      ),
                    );
                  },
                        ...
                        Column(
                          children: [
                            ElevatedButton.icon(
                              ...
                              onPressed: () {
                                launchUrl(
                                  Uri.parse("https://www.afdian.com/a/ourchat"),
                                );
                              },
